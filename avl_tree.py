...
class AVLTree:
    ...
    def _insert_at(self, root: TreeNode, new) -> TreeNode:
        ...
        # Right
        if balance < -1:
            if self._get_balance(root.right) > 1:
    ...
    def _left_rotate(self, local_root: TreeNode) -> TreeNode:
        ...
        # Update heights
        local_root.height = self._get_max_height_of_children(local_root) + 1
        right_child.height = self._get_max_height_of_children(right_child) + 1
    ...
    def _right_rotate(self, local_root: TreeNode) -> TreeNode:
        ...
        # Update heights
        local_root.height = self._get_max_height_of_children(local_root) + 1
        left_child.height = self._get_max_height_of_children(left_child) + 1
